...
function ProductList({ onHomeClick }) {
    ...
    const [showPlants, setShowPlants] = useState(true); // Changed to true to show plants by default
    ...
    const handleAddToCart = (plant) => {
        // Dispatch the plant to the cart store
                ...
                <div style={styleObjUl}>
                    <div>
                        <a 
                            ...
                            style={styleA}
                            className={showPlants ? 'active-nav-link' : ''}
                        >
                            Plants
                        </a>
                    </div>
                    <div>
                        <a 
                            ...
                            style={styleA}
                            className={showCart ? 'active-nav-link' : ''}
                        >
                            <h1 className='cart'>
                        ...
                        <div key={categoryIndex} className="plant-category">
                            ...
                            <div className="plants-container">
                                {category.plants.map((plant, plantIndex) => (
                                    <div key={`${categoryIndex}-${plantIndex}`} className="plant-card">
